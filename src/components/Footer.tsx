  ...
  return (
    <div className='w-full h-[938px] bg-[#00359E] px-[16px] pt-[48px] md:px-[40px] font-inter text-[#ffffff]'>
      <div className='flex flex-col md:flex md:flex-row md:gap-12 border-b-[1px] border-[#ffffff] '>
        ...
        <div className='grid grid-cols-2 md:grid-cols-5 gap-8 md:flex-[0.60] my-[48px] font-semibold text-base'>
      ...
      <div className='flex flex-col-reverse md:flex-row justify-between'>
        <p className=' mt-[24px] md:mt-[48px] font-normal text-base'>© 2023 Pishon Inc. All rights reserved.</p>
