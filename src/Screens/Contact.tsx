...
">
        ...
        <div className='flex flex-col md:flex-row w-full py-[64px] md:py-[96px] px-[16px] md:px-[112px] h-[556px] md:h-[480px] bg-[#F9FAFB] mt-[64px]'>
          ...
          <div className='flex flex-col lg:flex-[0.44] py-[48px] md:py-0'>
