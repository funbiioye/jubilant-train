        ...
        <div className="flex flex-col md:flex-row pt-3 justify-between">
          <div>
            ...
            <input
              ...
              className="w-[343px] h-[44px] text-[#101828] md:w-[224px]  px-[14px] py-[10px] border-2 border-[#D0D5DD] focus:outline-none focus:border-[#32D583] focus:ring-1 focus:[#32D583] mt-[6px]  bg-white rounded-lg border-1"
            ></input>
          </div>
          <div className="md:ml-[32px]">
            ...
            <input
              ...
              className="w-[343px] h-[44px] text-[#101828] md:w-[224px] border-2 border-[#D0D5DD] focus:outline-none focus:border-[#32D583] focus:ring-1 focus:[#32D583]   mt-[6px] px-[14px] py-[10px] bg-white rounded-lg "
            ></input>
          </div>
        </div>
        <div className="grid grid-flow-row">
          <span>
            ...
            <input
              ...
              className="border-2 text-[#101828] border-[#D0D5DD] focus:outline-none focus:border-[#32D583] focus:ring-1 focus:[#32D583] w-[343px] md:w-[480px] h-[44px] mt-[6px] px-[14px] py-[10px] bg-white rounded-lg "
            ></input>
          </span>
          <span>
            ...
            <input
              ...
              className="border-2 border-[#D0D5DD] focus:outline-none focus:border-[#32D583] focus:ring-1 focus:[#32D583] w-[343px] md:w-[480px] h-[44px] mt-[6px] px-[14px] py-[10px] bg-white rounded-lg "
            ></input>
          </span>
