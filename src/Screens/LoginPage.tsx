    ...
    <div className='grid grid-flow-col w-full h-screen py-24 bg-white justify-center font-inter text-sm overflow-auto '>
      <div>
        ...
        <div className='flex  flex-col justify-center text-center pt-6'>
          ...
          <div className='px-[7.5px] sm:grid grid-flow-row pt-3'>
            <span>
            ...
            <span>
              ...
              <input
                ...
                className='border-2 border-[#D0D5DD] focus:outline-none focus:border-[#32D583] focus:ring-1 focus:[#32D583]       focus:invalid:border-pink-500 focus:invalid:ring-pink-500 w-[360px] h-[44px] mt-[6px] px-[14px] py-[10px] bg-white rounded-lg '></input>
            </span>
            ...
            <div className='grid grid-flow-row pt-6'>
              <a href=''>
                <button className='justify-center border-2 w-full h-[44px] mt-[24px] px-[153.5px] py-[10px] bg-[#00359E] font-semibold text-[16px] text-[#FFFFFF] leading-[24px]  rounded-lg  '>
                  Sign in
                </button>
              </a>
              {/* <span>
            <LogButton />
              ...
              <span className='grid grid-flow-row justify-center mt-8'>
                <p className='font-normal font-inter text-[14px] leading-[20px] text-[#475467]'>
                  ...
                  <a
                    className='text-[#00359E] text-[14px] font-inter font-semibold leading-[20px] ml-[4px]'
                    href='/'>
                    Sign up
                  </a>
                </p>
